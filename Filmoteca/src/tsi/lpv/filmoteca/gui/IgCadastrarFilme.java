...
public class IgCadastrarFilme extends JDialog {
	...
	private JPanel criaAbaDiretor(){
		...
		informacoePanel.setBounds(228, 11, 249, 100);
		diretorPanel.add(informacoePanel);
		...
		ajudaButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new IgAjuda(IgCadastrarFilme.this, "Cadastrar Diretor", MensagensAjuda.CADASTRAR_DIRETOR);
			}
		});
	...
	private JPanel criaAbaAutor(){
		...
		informacoePanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Informa\u00E7\u00F5es", TitledBorder.LEADING, TitledBorder.TOP, null, Color.WHITE));
		informacoePanel.setBounds(228, 11, 249, 100);
		autorPanel.add(informacoePanel);
		informacoePanel.setLayout(null);
		...
		ajudaButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new IgAjuda(IgCadastrarFilme.this, "Cadastrar Autor", MensagensAjuda.CADASTRAR_AUTOR);
			}
		});
	...
	private JPanel criaAbaArtista(){
		...
		informacoePanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Informa\u00E7\u00F5es", TitledBorder.LEADING, TitledBorder.TOP, null, Color.WHITE));
		informacoePanel.setBounds(228, 11, 249, 100);
		artistaPanel.add(informacoePanel);
		informacoePanel.setLayout(null);
		...
		ajudaButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new IgAjuda(IgCadastrarFilme.this, "Cadastrar Atores", MensagensAjuda.CADASTRAR_ATOR);
			}
		});
	...
	private JPanel criaAbaPoster(){
		...
		ajudaButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new IgAjuda(IgCadastrarFilme.this, "Cadastrar Pôster", MensagensAjuda.CADASTRAR_POSTER);
			}
		});
